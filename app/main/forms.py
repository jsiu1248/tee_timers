...
class GolfLogForm(FlaskForm):
    ...
    # Calculate points for golflog based on action and satisfaction level
    def calculate_points(action, satisfaction):
        ...
        multiplier = satisfaction_multipliers.get(satisfaction, 1.0)
